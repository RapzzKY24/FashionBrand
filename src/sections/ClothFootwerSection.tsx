        ...
        <div className="grid grid-cols-2 items-center gap-24">
          ...
          <div className="space-y-8">
            ...
            <p className="font-roboto font-light text-[16px] text-gray-300 leading-7 max-w-xl">
              ...
              designed to complement a range of occasions, from everyday casual
              wear to statement-making outfits for special events
            </p>

            <button className="border border-white text-white px-6 py-4 rounded-sm hover:bg-white hover:text-black transition-all duration-300">
              Explore Products
            </button>
          </div>
        </div>

...
const CollectionsPage = () => {
  return (
    <section className="min-h-screen bg-white pt-24 pb-10">
      ...
      <motion.div
        className="grid grid-cols-5 gap-3 px-16 py-5"
      ...
      >
        {topCategories.map((item) => (
          <motion.div key={item.title} variants={staggerItem}>
            <Link
              href="/shop"
              className="group relative h-28 overflow-hidden rounded-md bg-neutral-200 block"
            >
      ...
      <div className="grid grid-cols-12 border-t border-gray-200">
        <motion.aside
          className="col-span-2 border-r border-gray-200 px-16 py-8"
          ...
          >
            {collections.map((item) => (
              <motion.div key={item.title} variants={staggerItem}>
                <Link
                  href="/shop"
                  className="group overflow-hidden rounded-md border border-gray-200 bg-white block"
                >
